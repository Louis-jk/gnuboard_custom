                ...
                <div class="bo_fx">
                    <?php if ($list_href || $write_href) { ?>
                        <ul class="btn_bo_user">
                            <?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn_admin btn" title="관리자"><i class="fa fa-user-circle" style="margin-right:2px;"></i>관리자</a></li><?php } ?>
                            <?php if ($rss_href) { ?><li><a href="<?php echo $rss_href ?>" class="btn_b01 btn" title="RSS"><i class="fa fa-rss" aria-hidden="true"></i><span class="sound_only">RSS</span></a></li><?php } ?>
                            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="글쓰기"><i class="fa fa-pencil" style="margin-right:2px; color:#fff;" aria-hidden="true"></i>글쓰기</a></li><?php } ?>
                        </ul>
                    <?php } ?>
                </div>
            <?php } ?>
            ...
            <table>
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="mb_disp_no"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회 </a></th>
                        <?php if ($is_good) { ?><th scope="col"><?php echo subject_sort_link('wr_good', $qstr2, 1) ?>추천 </a></th><?php } ?>
                        <?php if ($is_nogood) { ?><th scope="col"><?php echo subject_sort_link('wr_nogood', $qstr2, 1) ?>비추천 </a></th><?php } ?>
                        <th scope="col" class="mb_disp_no"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜 </a></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    ?>
                        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
                            ...
                            <td class="td_name sv_use mb_disp_no"><?php echo $list[$i]['name'] ?></td>
                            <td class="td_num mb_disp_no"><?php echo $list[$i]['wr_hit'] ?></td>
                            <?php if ($is_good) { ?><td class="td_num"><?php echo $list[$i]['wr_good'] ?></td><?php } ?>
                            <?php if ($is_nogood) { ?><td class="td_num"><?php echo $list[$i]['wr_nogood'] ?></td><?php } ?>
                            <td class="td_datetime mb_disp_no"><?php echo $list[$i]['datetime2'] ?></td>
        ...
        <div class="bo_fx">
            <?php if ($is_checkbox) { ?>
                <ul class="btn_bo_user">
                    ...
                    <li><a href="./write.php?bo_table=sub0401" class="btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 글쓰기</a></li>
                <?php } ?>
                </ul>
        </div>
        <!-- //커스텀 -->
