...
<div class="product_lt">
	...
	<div class="variable slider">
		...
		?>
			<div class="product_lt_wrap">
				<a href="<?php echo $list[$i]['href'] ?>" class="lt_img"><?php echo $img_content; ?></a>
				<span class="main_more02"><img src="<?php echo G5_THEME_IMG_URL ?>/aLink_arrow02.png" title="">
					<p>more</p>
				</span>
				<div class="gall_content">
					...
					<div class="box-content">
						...
						<!--<?php $list[$i]['wr_content'] = cut_str($list[$i]['wr_content'], 70, "..");
